    ...
    @endif
		<div class="panel panel-default">
					<div class="panel-heading">
						<strong> Tambah Opsi Bahasa </strong>
					</div>
					<div class="panel-body">
						{!! Form::open(['url'=>'Admin/tambah/bahasa/post', 'method'=>'POST']) !!}
							<fieldset>
								<div class="row">
								</div>
								<div class="row">
									<div class="col-sm-12 col-md-10  col-md-offset-1 ">
										...
										{!! Form::label('opsi_bahasa') !!}
											<div class="input-group">
												<span class="input-group-addon">
													<i class="glyphicon glyphicon-thumbs-up"></i>
												</span> 
												
												{!! Form::text('opsi_bahasa',null, ['class'=>'form-control', 'placeholder'=>'Bahasa']) !!}
											</div>
										</div>
										<div class="form-group">
												<div class="row">
	...
	<div class="panel panel-default">
            ...
            @foreach($ngelists as $list)
                    ...
                    <tr>
                        ...
                        <td>{{ $list->id }}</td>
                        <td>{{ $list->opsi_bahasa }}</td>
                        <td><center><a href="{{ url('bahasa/ubah',$list->id) }}" class="btn btn-warning"><span class="glyphicon glyphicon-book"></span> Ubah</a></center></td>
                        <td><center>{!! Form::open(['url' => ['bahasa/hapus/bahasa',$list->id], 'method' => 'delete']) !!}
