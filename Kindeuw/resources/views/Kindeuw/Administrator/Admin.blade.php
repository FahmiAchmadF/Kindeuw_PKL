...
<div class="col-lg-2 col-xs-2 sidebar paddingnol">
	...
	<div class="col-lg-12 col-xs-12 spasi"><h4>Hello!</h4><center><h1>Admin</h1></center></div>
	...
	<div class="col-lg-12 col-xs-12 paddingnol">
		<a href="{{ url('Kindeuw/admin/admincustom{id}') }}" class="btn btn-dark btn-lg btn-block bordernol2"><span class="glyphicon glyphicon-wrench"></span> PENGATURAN AKUN</a>
	</div>
	...
	<div class="col-lg-12 col-xs-12 paddingnol">
		<a href="{{ url('Kindeuw/create') }}" class="btn btn-dark btn-lg btn-block bordernol2"><span class="glyphicon glyphicon-plus"></span> BUAT DATA BUKU</a>
	</div>
	<div class="col-lg-12 col-xs-12 paddingnol">
